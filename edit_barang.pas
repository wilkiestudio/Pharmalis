...
procedure Tfedit_barang.kodeotomatis;
...
begin
  ...
  with ADOQuery1 do
    begin
      active:=false;
      sql.Clear;
      sql.Text:='SELECT * FROM combobox_list WHERE kategori='+QuotedStr(edit14.Text)+' ORDER BY nama ASC';
      active:=true;
      while not EoF do
        begin
...
procedure Tfedit_barang.keyboardcek;
begin
...
procedure Tfedit_barang.Button1Click(Sender: TObject);
begin
  with ADOTable1 do
    begin
      append;
  ...
  ShowMessage('Data '+edit14.Text+' dengan id '+edit7.Text+' berhasil disimpan.'+#13+#13+
  ...
  if (Application.MessageBox('Apakah anda ingin menambahkan master barang baru?','Konfirmasi Ulang',MB_YESNO or MB_ICONQUESTION)=ID_YES) then
    begin
      ...
      ComboBox2.SetFocus;button1.Enabled:=false;kodeotomatis;ComboBox2.ItemIndex:=0;
    end
  else
    begin
      Close;
...
procedure Tfedit_barang.Button2Click(Sender: TObject);
begin
...
procedure Tfedit_barang.ComboBox2Change(Sender: TObject);
begin
  keyboardcek;
end;

procedure Tfedit_barang.ComboBox2KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
...
procedure Tfedit_barang.ComboBox3Change(Sender: TObject);
begin
  keyboardcek;
end;

procedure Tfedit_barang.ComboBox3KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.ComboBox4Change(Sender: TObject);
begin
  if ComboBox4.ItemIndex<>-1 then
    begin
      edit7.Enabled:=true;
...
procedure Tfedit_barang.ComboBox4KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.ComboBox5Change(Sender: TObject);
begin
  if ComboBox5.ItemIndex<>-1 then
    begin
      edit8.Enabled:=true;
...
procedure Tfedit_barang.ComboBox5KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.Edit10Change(Sender: TObject);
begin
  keyboardcek;
end;

procedure Tfedit_barang.Edit10KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.Edit11KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.Edit12KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.Edit13KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.Edit1Change(Sender: TObject);
begin
  keyboardcek;
end;

procedure Tfedit_barang.Edit1KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.Edit2Change(Sender: TObject);
begin
  keyboardcek;
end;

procedure Tfedit_barang.Edit2KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.Edit3Change(Sender: TObject);
begin
  keyboardcek;
end;

procedure Tfedit_barang.Edit3KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.Edit4Change(Sender: TObject);
begin
  keyboardcek;
end;

procedure Tfedit_barang.Edit4KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.Edit5KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.Edit6Change(Sender: TObject);
begin
  keyboardcek;
end;

procedure Tfedit_barang.Edit6KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.Edit7KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.Edit8KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
    begin
      if button1.Enabled=true then button1.Click else
...
procedure Tfedit_barang.Edit9Change(Sender: TObject);
begin
  with ADOQuery1 do
    begin
      active:=false;
      sql.Clear;
      sql.Text:='SELECT * FROM mst_barang WHERE id='+QuotedStr(edit9.Text);
      active:=true;
      edit14.Text:=FieldValues['kategori'];
      edit1.Text:=FieldValues['nama'];
      edit2.Text:=FieldValues['satuan_besar'];
      edit3.Text:=FieldValues['isi'];
      edit4.Text:=FieldValues['satuan_kecil'];
      edit5.Text:=FieldValues['barcode'];
      edit1.Text:=FieldValues['nama'];
    end;
end;

procedure Tfedit_barang.FormActivate(Sender: TObject);
begin
  kodeotomatis;
  edit1.Clear;edit2.Clear;edit3.Clear;edit4.Clear;edit5.Clear;edit6.Clear;edit7.Clear;
  edit8.Clear;edit9.Clear;edit10.Clear;edit11.Clear;edit12.Clear;edit13.Clear;
